...
var emptyValue = (argument_count == 4) ? argument[3] : 0 //Only used for ds_grid
...
assert_with_error_message(result, ds_type_name(ds_type) + " " + __get_emptiness_message(condition), index)